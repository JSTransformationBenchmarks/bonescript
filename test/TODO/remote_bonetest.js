...
function _onSocketIOLoaded() {
  ...
  async function getRequireData(m) {
...
function _seqcall(data) {
  if (typeof data.seq != 'number' || typeof _bonescript._callbacks[data.seq] != 'function') throw "Invalid callback message received: " + JSON.stringify(data);
...
var require = function (module) {
  if (typeof _bonescript.modules[module] == 'undefined') throw 'Module "' + module + '" is not currently available';
